...
kind 별 가이드:
- cover: title/subtitle/author/date. subtitle 은 한 줄 부제.
- agenda: items 2~7개. 명사구. **번호(01., 1., I. 등) 금지** — 렌더가 자동으로 부여한다. 본 deck 의 section 슬라이드 title 과 정확히 동일한 표기.
...
- image: title/imageRef/caption. imageRef 는 짧은 슬러그 또는 KB 자료 제목.
